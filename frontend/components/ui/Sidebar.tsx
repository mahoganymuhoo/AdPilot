...
import { BarChart2, TrendingUp, Lightbulb, Settings, Package, Upload, BookOpen, Target, AlertTriangle } from "lucide-react";
...
// Demo: gerçekte useAnomalies() hook'undan gelecek
...
export default function Sidebar() {
  ...
  return (
    <>
      <aside className="fixed top-0 left-0 h-full w-64 bg-white border-r border-gray-200 flex flex-col z-30">
